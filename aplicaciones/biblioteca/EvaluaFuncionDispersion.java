    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            for (fdis = 0; fdis < Termino.NOMFDIS.length; fdis++) {  
                ...
                //COMPLETAR
                tH = construirTabla("lista10.txt", fdis);       
                        //2.- Mostrar por pantalla los valores de factor de carga y desviacion tipica
                        
                        //COMPLETAR               
                System.out.println("Factor de carga: " + tH.factorCarga()
                                   + " | Desviación tipicia: " + tH.desviacionTipica());                      
